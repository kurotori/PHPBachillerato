<?php 
    ...
    $datosConsulta->modo = $objetoJson->modo;

    switch ($datosConsulta->modo) {
        case 'guardar':
            # code...
            guardarLibro($datosConsulta->dato);
            break;
    ...
    function guardarLibro($datosLibro){
        ...
        if ($basededatos->estado == "OK") {
            ...
            try {
                ...
                $consulta = "Insert into libro(ISBN,fecha_pub,genero,titulo,nombre_autor,apellido_autor) values (?,?,?,?,?,?)";
                ...
                $sentencia->bind_param('isssss',
                                        $datosLibro->ISBN,
                                        $datosLibro->fecha_pub,
                                        $datosLibro->genero,
                                        $datosLibro->titulo,
                                        $datosLibro->nombre_autor,
                                        $datosLibro->apellido_autor
                                        );
            ...
            } catch (Exception $excepcion){//mysqli_sql_exception $excepcion) {
